				...
				<FadeIn>
					...
					<Box sx={{ py: { xs: 2, md: 4 }, px: { xs: 2, md: 8 }, textAlign: "justify" }}>
						<Typography
							...
							2022, and applies to citizens and legal permanent residents of the European Economic Area
							and Switzerland.
						</Typography>
						...
						<Typography sx={{ fontFamily: "Roboto", fontWeight: 300, fontSize: "14px", mb: 2 }}>
							...
							of your personal data, you have the right to submit a complaint to the Data Protection
							Authority.
						</Typography>
