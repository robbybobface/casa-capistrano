			...
			<Container>
				<FadeIn>
					...
					<Box
						component='main'
						role='main'
						aria-label='Privacy Statement UK'
						...
						<Box component='section' role='region' aria-label='Purpose'>
							...
							<Typography
								component='a'
								role='link'
								aria-label='legal bases definition'
						...
						<Box component='section' role='region' aria-label='Submitting a complaint'>
							...
							<Typography sx={{ fontFamily: "Roboto", fontWeight: 300, fontSize: "14px", mb: 2 }}>
								...
								processing of your personal data, you have the right to submit a complaint to the
