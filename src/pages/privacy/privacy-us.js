				...
				<FadeIn>
					...
					<Box
						...
						<Typography
							...
							2022, and applies to citizens and legal permanent residents of the United States.
						</Typography>
						...
						<Box component='section' role='region' aria-label='Purpose and Categories of data'>
							<Typography
								component='h2'
						...
						<Box component='section' role='region' aria-label='Do Not Track Signals & Privacy Control'>
							<Typography
								component='h2'
								sx={{ fontFamily: "Roboto", fontWeight: 500, fontSize: "22px", mb: 2 }}>
						...
						<Box component='section' role='region' aria-label='Cookies Explained'>
							<Typography
								component='h2'
								sx={{ fontFamily: "Roboto", fontWeight: 500, fontSize: "22px", mb: 2 }}>
								4. Cookies
							...
							<Typography sx={{ fontFamily: "Roboto", fontWeight: 300, fontSize: "14px", mb: 2 }}>
								...
								<Typography
									component='span'
									role='link'
									aria-label='To Cookie Policy (US)'
									sx={{
										textDecoration: "underline",
										fontFamily: "Roboto",
										fontWeight: 300,
						...
						<Box component='section' role='region' aria-label='Accessing and modifying your data'>
							...
							<Typography sx={{ fontFamily: "Roboto", fontWeight: 300, fontSize: "14px", mb: 2 }}>
								...
								contact us by using the information below. You have the following rights:
							</Typography>
							<Typography
								component='h3'
								sx={{ fontFamily: "Roboto", fontWeight: 700, fontSize: "14px", mb: 2 }}>
