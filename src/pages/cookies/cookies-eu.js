				...
				<FadeIn>
					...
					<Box sx={{ py: { xs: 2, md: 4 }, px: { xs: 2, md: 8 }, textAlign: "justify" }}>
						<Typography
							...
							applies to citizens and legal permanent residents of the European Economic Area and
							Switzerland.
						</Typography>
						...
						<Typography sx={{ fontFamily: "Roboto", fontWeight: 300, fontSize: "14px", mb: 2 }}>
							...
							about cookies. As soon as you click on “Save preferences”, you consent to us using the
							categories of cookies and plug-ins you selected in the pop-up, as described in this Cookie
							Policy. You can disable the use of cookies via your browser, but please note that our
