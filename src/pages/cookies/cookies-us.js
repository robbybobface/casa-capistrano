			...
			<Container>
				<FadeIn>
					...
					<Box sx={{ py: { xs: 2, md: 4 }, px: { xs: 2, md: 8 }, textAlign: "justify" }}>
						...
						<Typography sx={{ fontFamily: "Roboto", fontWeight: 300, fontSize: "14px", mb: 2 }}>
							When you visit our website it can be necessary to store and/or read certain data from your
							device by using technologies such as cookies.
						</Typography>
						...
						<ol style={{ fontFamily: "Roboto", fontWeight: 300, fontSize: "14px" }}>
							<li>
							...
							<li>
								<Typography sx={{ fontFamily: "Roboto", fontWeight: 300, fontSize: "14px", mb: 0.5 }}>
									The expiration period shows the length of the period the used technology can “store
									or read certain data.”
								</Typography>
							</li>
						</ol>
